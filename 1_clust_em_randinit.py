...
for (fname, label, abbrev, best_k, best_type) in runs:
	...
	plt.savefig(path.join(PLOT_DIR, abbrev + "_em_bic.png"), bbox_inches='tight')
	plt.show()
	plt.close()
	...
	plt.subplots_adjust(hspace=.35, bottom=.02)
	plt.savefig(path.join(PLOT_DIR, abbrev + "_em_ch.png"), bbox_inches='tight')
	plt.show()
	plt.close()
	...
	plt.subplots_adjust(hspace=.35, bottom=.02)
	plt.savefig(path.join(PLOT_DIR, abbrev + "_em_silhouette.png"), bbox_inches='tight')
	plt.show()
	plt.close()

	# predict best clusters
	model = mixture.GaussianMixture(n_components=best_k,
	...
	plt.savefig(path.join(PLOT_DIR, abbrev + "_em_scatter.png"), bbox_inches='tight')
	plt.show()
	plt.close()
	...
	visualizer.finalize()
	plt.savefig(path.join(PLOT_DIR, abbrev + "_em_parallel.png"), bbox_inches='tight')
	visualizer.show()
	plt.close()
