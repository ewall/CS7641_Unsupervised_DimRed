...
for (fname, label, abbrev, best_k, best_type) in runs:
	...
	plt.savefig(path.join(PLOT_DIR, abbrev + "_em-ica_bic.png"), bbox_inches='tight')
	plt.show()
	plt.close()
	...
	plt.subplots_adjust(hspace=.35, bottom=.02)
	plt.savefig(path.join(PLOT_DIR, abbrev + "_em-ica_ch.png"), bbox_inches='tight')
	plt.show()
	plt.close()
	...
	plt.subplots_adjust(hspace=.35, bottom=.02)
	plt.savefig(path.join(PLOT_DIR, abbrev + "_em-ica_silhouette.png"), bbox_inches='tight')
	plt.show()
	plt.close()
	...
	df.to_pickle(path.join(PKL_DIR, abbrev + "_em-ica.pickle"))
	...
	plt.savefig(path.join(PLOT_DIR, abbrev + "_em-ica_scatter.png"), bbox_inches='tight')
	plt.show()
	plt.close()
	...
	visualizer.finalize()
	plt.savefig(path.join(PLOT_DIR, abbrev + "_em-ica_parallel.png"), bbox_inches='tight')
	visualizer.show()
	plt.close()
